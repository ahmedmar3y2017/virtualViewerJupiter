define(["vvDefines"], function(vvDefines) {
    ...
    var vvConfig =
       ...
       */ 
         ...
         * @memberof vvConfig
         */
        pageManipulationsNewDocumentMenu: false,
         ...
         */
        /**
         * @member {boolean} autoplay Autoplay videos when they are ready.
         ...
         * @see VirtualViewer#getVideoPlayer
         * @see vvConfig.autoplay
         * @see vvConfig.videoMuted
         * @see vvConfig.videoStretch
         * @memberof vvConfig
         */
